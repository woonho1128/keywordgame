...
public record MonopolyState(
    ...
    public record PlayerView(int seat, String name, boolean bot, boolean host, boolean me,
                             int color, int team, long cash, int pos, boolean alive, boolean inIsland, boolean left, int props) {}
    ...
    public static MonopolyState notFound(long now) {
        return new MonopolyState("NONE", false, false, false, List.of(), List.of(), -1, null, false, -1,
