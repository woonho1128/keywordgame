...
- **AI 사주** — 사주팔자는 서버가 계산하고 해석만 AI가 (종합/연애/재물/직업/공부/건강/올해/미래인연)
...
- [x] **AI 사주 완료**
  ...
  - [x] 사주 8종 (종합/연애/재물/직업/공부/건강/올해의 운세/미래인연)
...
- [x] **궁합 완료**
  ...
  - [x] 결과 이미지 저장 — 결과 전체를 캔버스로 그려 PNG 저장/공유 (가로 1080, 세로는 내용만큼)
  - [x] 요점 카드(highlights) — 미래인연의 횟수·자리·시기처럼 답을 한눈에
  - [x] 인연 연표 — 지난 기회 + 앞으로의 인연을 연도·장소·장면·상대 인상(나이대/직업결/성격)으로
    (연도는 연도별 세운 표에서만, 상대는 배우자성 위치·오행에서)
