...
const GAME_SLUG: Record<string, string> = {
  ...
  sixnimmt: 'sixnimmt', 'tetris-battle': 'tetris-battle', yacht: 'yacht', mojo: 'mojo', yut: 'yut', monopoly: 'monopoly', sherlock: 'sherlock', ciao: 'ciao', spicy: 'spicy', snakes: 'snakes', quiz: 'quiz',
};
// 엔트리형(방을 localStorage로 복원하지 않는) 게임 → ?join=CODE 쿼리로 자동 참가
const ENTRY_GAMES = new Set(['sixnimmt', 'tetris-battle', 'yacht', 'mojo', 'yut', 'monopoly', 'sherlock', 'ciao', 'spicy', 'snakes', 'quiz']);
