...
export const LOCATIONS: SpyfallLocation[] = [
  ...
  },
  {
    name: '은행',
    en: 'Bank',
    roles: ['상담원', '도둑', '고객', '지점장', '환전 직원', '창구 직원', '경비원', '대출 담당자', '인턴', '청원경찰', 'VIP 고객', '청소부'],
  },
  {
    name: '해변',
    en: 'Beach',
    roles: ['안전 요원', '모래놀이 하는 아이', '길거리 음식 노점상', '사진사', '해수욕장 관리인', '피서객', '도둑', '서퍼', '아이스크림 장수', '비치발리볼 선수', '커플', '조개 줍는 사람'],
  },
  {
    name: '카니발 축제',
    en: 'Carnival',
  ...
  },
  {
    name: '회식',
    en: 'Corporate Party',
    roles: ['CEO', '비서실장', '경리', '과장', '매니저', '대리', '팀장', '신입사원', '부장', '인턴', '거래처 손님', '식당 종업원'],
  },
  {
    name: '십자군 군대',
    en: 'Crusader Army',
    roles: ['방패병', '하인', '수도승', '궁수', '대지주', '주교', '기사', '창병', '대장장이', '종군 의사', '척후병', '왕'],
  },
  {
    name: '온천 스파',
    en: 'Day Spa',
    roles: ['온천 안내원', '손님', '피부과 전문의', '피부 미용사', '마사지사', '네일 아티스트', '세신사(때밀이)', '접수원', '요가 강사', '사우나 관리인', '청소부', '단골 손님'],
  },
  {
    name: '대사관',
    en: 'Embassy',
  ...
  },
  {
    name: '나이트클럽',
    en: 'Nightclub',
    roles: ['입구 지키미', 'DJ', '단골', '모델', '댄서', '픽업아티스트', '바텐더', '웨이터', '사장', '취객', '경비원', '주차 요원'],
  },
  {
    name: '원양 정기선',
    en: 'Ocean Liner',
  ...
  },
  {
    name: '식당',
    en: 'Restaurant',
    roles: ['지배인', '그릇 치우는 직원', '서빙 알바생', '손님', '웨이터', '음식 비평가', '쉐프', '주방 보조', '계산원', '배달원', '단골 손님', '설거지 담당'],
  },
  {
    name: '학교',
    en: 'School',
  ...
  },
  {
    name: '극장',
    en: 'Theater',
    roles: ['감독', '무대 담당자', '배우', '표 검사원', '음향 담당', '관객', '물품 보관소 안내원', '매표원', '조명 담당', '분장사', '극작가', '매점 직원'],
  },
  {
    name: '대학',
    en: 'University',
  ...
  },
  {
    name: '보드 게임 가게',
    en: 'Board Game Store',
    roles: ['가게 주인', '모르는 게 없는 손님', '처음 온 사람', '게임 디자이너', '시급 제대로 못받는 알바생', '단골 손님', '전쟁 게임 마니아', 'RPG 게임 마니아', '리빙카드게임 마니아', '초등학생 손님', '대회 참가자', '계산대 직원'],
  },
  {
    name: '공동묘지',
    en: 'Cemetery',
  ...
  },
  {
    name: '카페',
    en: 'Coffee Shop',
    roles: ['바리스타', '손님', '노트북 하는 손님', '작가가 되고 싶은 사람', '버림받은 애인', '가정주부', '가게 매니저', '책 읽는 손님', '회의하는 회사원', '단골 손님', '대학생', '알바생'],
  },
  {
    name: '어린이집',
    en: 'Daycare Center',
